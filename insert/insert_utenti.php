<?php
    ...
    $query = "
                ...
                (nome, cognome, data_nascita, admin, email, password, indirizzo, id_provincia)
                VALUES
                (:nome_utente, :cognome_utente, :data_nascita, :admin, :email_utente, :psw_utente, :indirizzo_utente, :provincia_utente)";
